(() => {
	...
	const sceneInfo = [
		{
			...
			values: { //바꿀 곳
				videoImageCount: 43, //비디오에 넣을 이미지 개수 
				imageSequence: [0, 42], //이미지 개수 인덱스
		...
		},
		{
			...
			values: {
				videoImageCount: 54, //바꿀곳 사진 개수
				imageSequence: [0, 53], //사진 개수 인덱스
		...
		},
		{
			...
			objs: {
				...
				imagesPath: [
					'/resources/images/swaho1.JPG',
					'/resources/images/swaho3.jpg'
				],
				images: []
			},
			values: {
	...
	function setCanvasImages() {
		...
		for (let i = 0; i < sceneInfo[0].values.videoImageCount; i++) {
			imgElem = new Image();
			imgElem.src = `/resources/video/detail1_1/IMG_${1 + i}.JPG`;
		...
		for (let i = 0; i < sceneInfo[2].values.videoImageCount; i++) {
			imgElem2 = new Image();
			imgElem2.src = `/resources/video/detail1_2/IMG_${101 + i}.JPG`;

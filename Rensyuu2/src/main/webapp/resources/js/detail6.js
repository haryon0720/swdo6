(() => {
	...
	const sceneInfo = [
		{
			...
			values: { //바꿀 곳
				videoImageCount: 28, //비디오에 넣을 이미지 개수 
				imageSequence: [0, 27], //이미지 개수 인덱스
		...
		},
		{
			...
			values: {
				videoImageCount: 151, //바꿀곳 사진 개수
				imageSequence: [0, 150], //사진 개수 인덱스
		...
		},
		{
			...
			objs: {
				...
				imagesPath: [
					'/resources/images/penguin1.jpg',
					'/resources/images/penguin2.jpg'
				],
				images: []
			},
			values: {
	...
	function setCanvasImages() {
		...
		for (let i = 0; i < sceneInfo[0].values.videoImageCount; i++) {
			imgElem = new Image();
			imgElem.src = `/resources/video/detail6_1/d6_${1 + i}.JPG`;
		...
		for (let i = 0; i < sceneInfo[2].values.videoImageCount; i++) {
			imgElem2 = new Image();
			imgElem2.src = `/resources/video/detail6_2/d6_${101 + i}.JPG`;

(() => {
	...
	const sceneInfo = [
		{
			...
			values: { //바꿀 곳
				videoImageCount: 35, //비디오에 넣을 이미지 개수 
				imageSequence: [0, 34], //이미지 개수 인덱스
		...
		},
		{
			...
			values: {
				videoImageCount: 86, //바꿀곳 사진 개수
				imageSequence: [0, 85], //사진 개수 인덱스
		...
		},
		{
			...
			objs: {
				...
				imagesPath: [
					'/resources/images/okonomi1.jpg',
					'/resources/images/okonomi2.jpg'
				],
				images: []
			},
			values: {
	...
	function setCanvasImages() {
		...
		for (let i = 0; i < sceneInfo[0].values.videoImageCount; i++) {
			imgElem = new Image();
			imgElem.src = `/resources/video/detail7_1/IMG_${1 + i}.JPG`;
		...
		for (let i = 0; i < sceneInfo[2].values.videoImageCount; i++) {
			imgElem2 = new Image();
			imgElem2.src = `/resources/video/detail7_2/d7_${101 + i}.JPG`;

(() => {
	...
	const sceneInfo = [
		...
		},
		{
			...
			values: {
				videoImageCount: 90, //바꿀곳 사진 개수
				imageSequence: [0, 89], //사진 개수 인덱스
		...
		}, 
		{
			...
			objs: {
				...
				imagesPath: [
					'/resources/images/odaiba1.jpg',
					'/resources/images/odaiba2.jpg'
				],
				images: []
			},
			values: {
	...
	function setCanvasImages() {
		...
		for (let i = 0; i < sceneInfo[0].values.videoImageCount; i++) {
			imgElem = new Image();
			imgElem.src = `/resources/video/detail5_1/d5_${1 + i}.JPG`;
		...
		for (let i = 0; i < sceneInfo[2].values.videoImageCount; i++) {
			imgElem2 = new Image();
			imgElem2.src = `/resources/video/detail5_2/d5_${101 + i}.JPG`;

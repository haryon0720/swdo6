(() => {
	...
	const sceneInfo = [
		{
			...
			values: { //바꿀 곳
				videoImageCount: 22, //비디오에 넣을 이미지 개수 
				imageSequence: [0, 21], //이미지 개수 인덱스
		...
		},
		{
			...
			values: {
				videoImageCount: 75, //바꿀곳 사진 개수
				imageSequence: [0, 74], //사진 개수 인덱스
		...
		},
		{
			...
			objs: {
				...
				imagesPath: [
					'/resources/images/himawari1.jpg',
					'/resources/images/himawari2.jpg'
				],
				images: []
			},
			values: {
	...
	function setCanvasImages() {
		...
		for (let i = 0; i < sceneInfo[0].values.videoImageCount; i++) {
			imgElem = new Image();
			imgElem.src = `/resources/video/detail2_1/d2_${1 + i}.JPG`;
		...
		for (let i = 0; i < sceneInfo[2].values.videoImageCount; i++) {
			imgElem2 = new Image();
			imgElem2.src = `/resources/video/detail2_2/d2_${101 + i}.JPG`;

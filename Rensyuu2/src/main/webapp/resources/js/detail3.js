(() => {
	...
	const sceneInfo = [
		{
			...
			values: { //바꿀 곳
				videoImageCount: 19, //비디오에 넣을 이미지 개수 
				imageSequence: [0, 18], //이미지 개수 인덱스
		...
		},
		{
			...
			values: {
				videoImageCount: 188, //바꿀곳 사진 개수
				imageSequence: [0, 187], //사진 개수 인덱스
		...
		},
		{
			...
			objs: {
				...
				imagesPath: [
					'/resources/images/kawa1.jpg',
					'/resources/images/kawa2.jpg'
				],
				images: []
			},
			values: {
	...
	function setCanvasImages() {
		...
		for (let i = 0; i < sceneInfo[0].values.videoImageCount; i++) {
			imgElem = new Image();
			imgElem.src = `/resources/video/detail3_1/d3_${1 + i}.JPG`;
		...
		for (let i = 0; i < sceneInfo[2].values.videoImageCount; i++) {
			imgElem2 = new Image();
			imgElem2.src = `/resources/video/detail3_2/d3_${101 + i}.JPG`;
